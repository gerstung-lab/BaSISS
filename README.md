...
```
Create a new cond environment with all the necessery packages installed
```
...
The experimental data consists of several layers of information, the main parts are 1) BaSISS or ISS singals, 2) Backround tissue image (DAPI) and 3) Selected regions of interest. To make the downstream analysis easier we store these layers in a single `basiss.preprocessing.Sample` object.
#### <a href="https://github.com/gerstung-lab/BaSISS/blob/main/notebooks/sc_spatial_typing.ipynb">Single cell saptial typing</a>
*In-situ* sequencing signals do not directly reveal which cell they are derived from. This makes donwstream analysis limited, since differential expression
...
Subclone mapping in case 2 (PD14780) which includes two ER negative
